function [e_i,e_q,p_i,p_q,l_i,l_q,carrierfq,codefq] = findandtrack(prn,msec,fs,intfreq)
%findandtrack
...
prn=prn;%18;  %GPS satellite number (03 05 06 09 12 14 18 21 22 30 31 )
msec_to_process = msec;%1000;  %msec of data to process
fs=fs;%4.096e6;  %sampling frequency
intfreq=intfreq;%0e6;  %intermediate frequency
